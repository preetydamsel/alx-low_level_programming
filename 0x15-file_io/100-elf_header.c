...
void print_type(unsigned int e_type, unsigned char
 *e_ident);
...
/**
 * check_elf - Checks if some file is an ELF file.
 * @e_ident: A pointer that is pointing to an array containing the ELF magic numbers.
