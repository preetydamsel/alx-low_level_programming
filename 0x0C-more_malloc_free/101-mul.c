 ...
 * @zeroes: if mult contains a non- digit,the function
...
/**
 * add_nums - Adds the numbers stored in the two strings
 ...
 * contains non-digits, the functions exits with a status of 98
 * Return: Always 0.
 */
